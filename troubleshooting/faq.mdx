...
- **A scheduled or repeating broadcast cannot be edited.** Cancel or stop it, then duplicate it. See [Scheduled and repeating broadcasts](/whatsapp/scheduled-broadcasts).
